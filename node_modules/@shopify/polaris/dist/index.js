...
function buildCustomPropertiesNoMemo(themeConfig, tokens) {
  ...
  return customPropertyTransformer(_objectSpread2(_objectSpread2(_objectSpread2({}, distModern.colorFactory(colors, colorScheme, mergedConfig)), tokens), {}, {
    frameOffset
  }));
}
...
function Icon({
  ...
  const className = classNames(styles$1.Icon, color && styles$1[variationName('color', color)], color && styles$1.applyColor, backdrop && styles$1.hasBackdrop);
...
function Spinner({
  ...
  const isAfterInitialMount = useIsAfterInitialMount();
  const className = classNames(styles$3.Spinner, size && styles$3[variationName('size', size)]);
...
function Badge({
  ...
  let accessibilityMarkup = hasAccessibilityLabel && /*#__PURE__*/React__default.createElement(VisuallyHidden, null, accessibilityLabel);

  if (progressLabel) {
    accessibilityMarkup = /*#__PURE__*/React__default.createElement("span", {
...
function Item({
  ...
  const className = classNames(styles$9.Item, disabled && styles$9.disabled, destructive && styles$9.destructive, active && styles$9.active);
  let prefixMarkup = null;

  if (prefix) {
    prefixMarkup = /*#__PURE__*/React__default.createElement("span", {
  ...
  const contentMarkup = helpText ? /*#__PURE__*/React__default.createElement("span", {
    className: styles$9.ContentBlock
  }, /*#__PURE__*/React__default.createElement("span", {
    className: styles$9.ContentBlockInner
  }, contentText), /*#__PURE__*/React__default.createElement(TextStyle, {
    variation: "subdued"
  ...
  const textMarkup = /*#__PURE__*/React__default.createElement("span", {
    className: styles$9.Text
  }, contentMarkup);
  const contentElement = /*#__PURE__*/React__default.createElement("span", {
...
function ActionList({
  ...
  const className = classNames(styles$9.ActionList);
...
function UnstyledButton(_ref) {
  let {
    ...
    onTouchStart
      ...
      rest = _objectWithoutProperties(_ref, ["id", "children", "className", "url", "external", "download", "submit", "disabled", "loading", "pressed", "accessibilityLabel", "role", "ariaControls", "ariaExpanded", "ariaDescribedBy", "onClick", "onFocus", "onBlur", "onKeyDown", "onKeyPress", "onKeyUp", "onMouseEnter", "onTouchStart"]);
...
function Button({
  ...
  const childMarkup = children ? /*#__PURE__*/React__default.createElement("span", {
    className: classNames(styles$a.Text, removeUnderline && styles$a.removeUnderline)
  }, children) : null;
  ...
  if (connectedDisclosure) {
    const connectedDisclosureClassName = classNames(styles$a.Button, primary && styles$a.primary, outline && styles$a.outline, size && size !== DEFAULT_SIZE$1 && styles$a[variationName('size', size)], textAlign && styles$a[variationName('textAlign', textAlign)], destructive && styles$a.destructive, connectedDisclosure.disabled && styles$a.disabled, styles$a.iconOnly, styles$a.ConnectedDisclosure, monochrome && styles$a.monochrome);
  ...
  const buttonMarkup = /*#__PURE__*/React__default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), /*#__PURE__*/React__default.createElement("span", {
...
function Section$2({
  ...
  const className = classNames(styles$e.Section, flush && styles$e['Section-flush'], subdued && styles$e['Section-subdued'], fullWidth && styles$e['Section-fullWidth'], hideOnPrint && styles$e['Section-hideOnPrint']);
  const actionMarkup = actions ? /*#__PURE__*/React__default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
...
const Card = function Card({
  ...
  const className = classNames(styles$e.Card, subdued && styles$e.subdued, hideOnPrint && styles$e.hideOnPrint);
...
function SecondaryAction(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("span", {
    className: styles$i.SecondaryAction,
...
function MenuGroup({
  ...
  const popoverActivator = /*#__PURE__*/React__default.createElement(SecondaryAction, {
    disclosure: true,
    icon: icon,
...
function Actions({
  ...
  const actionsMarkup = actions.map(action => {
    ...
    return /*#__PURE__*/React__default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest, {
  ...
  const rollUppableActionsMarkup = measuredActions.showable.length > 0 ? measuredActions.showable.map(action => action.content && /*#__PURE__*/React__default.createElement(SecondaryAction, Object.assign({
    key: action.content
  }, action, {
    getOffsetWidth: handleActionsOffsetWidth
  }), action.content)) : null;
  ...
  const groupedActionsMarkup = /*#__PURE__*/React__default.createElement(ButtonGroup, {
    spacing: "extraTight"
...
function ActionMenu({
  ...
  const actionMenuClassNames = classNames(styles$m.ActionMenu, rollup && styles$m.rollup);
...
function Checkbox({
  ...
  const className = classNames(styles$n.Checkbox, active && styles$n.active);
  ...
  const inputClassName = classNames(styles$n.Input, keyFocused && styles$n.keyFocused);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
...
var _ref$5 = /*#__PURE__*/React__default.createElement(Scrollable.ScrollTo, null);
...
function Option({
  ...
  const singleSelectClassName = classNames(styles$o.SingleSelectOption, focused && styles$o.focused, disabled && styles$o.disabled, select && styles$o.select, active && styles$o.active);
  const multiSelectClassName = classNames(styles$o.Label, disabled && styles$o.disabled, active && styles$o.active, select && styles$o.select);
  ...
  const scrollMarkup = active ? _ref$5 : null;
  return /*#__PURE__*/React__default.createElement("li", {
    key: id,
    className: styles$o.Option,
    tabIndex: -1
...
function Label({
  ...
  const className = classNames(styles$r.Label, hidden && styles$r.hidden);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
...
var _ref$6 = /*#__PURE__*/React__default.createElement(Icon, {
...
function Labelled(_ref) {
  ...
  const className = classNames(labelHidden && styles$t.hidden);
...
function Item$3({
  ...
  const className = classNames(styles$u.Item, focused && styles$u['Item-focused'], position === 'primary' ? styles$u['Item-primary'] : styles$u['Item-connection']);
  return /*#__PURE__*/React__default.createElement("div", {
    onBlur: forceFalseFocused,
    onFocus: forceTrueFocused,
    className: className
...
function Spinner$1({
  ...
  }, _ref$7)), /*#__PURE__*/React__default.createElement("div", {
    role: "button",
    className: styles$v.Segment,
    tabIndex: -1,
    onClick: handleStep(-1),
...
function TextField({
  ...
  const className = classNames(styles$v.TextField, Boolean(normalizedValue) && styles$v.hasValue, disabled && styles$v.disabled, readOnly && styles$v.readOnly, error && styles$v.error, multiline && styles$v.multiline, focus && styles$v.focus);
  ...
  const clearButtonClassName = classNames(styles$v.ClearButton, !clearButtonVisible && styles$v['ClearButton-hidden']);
  const clearButtonMarkup = clearButton ? /*#__PURE__*/React__default.createElement("button", {
    type: "button",
    className: clearButtonClassName,
    onClick: handleClearButtonPress,
    disabled: disabled,
    tabIndex: clearButtonVisible ? 0 : -1
  }, /*#__PURE__*/React__default.createElement(VisuallyHidden, null, i18n.translate('Polaris.Common.clear')), _ref$8) : null;
  ...
  const inputClassName = classNames(styles$v.Input, align && styles$v[variationName('Input-align', align)], suffix && styles$v['Input-suffixed'], clearButton && styles$v['Input-hasClearButton']);
  const input = /*#__PURE__*/React.createElement(multiline ? 'textarea' : 'input', _objectSpread2({
    name,
    id,
    disabled,
    readOnly,
  ...
  const backdropClassName = classNames(styles$v.Backdrop, connectedLeft && styles$v['Backdrop-connectedLeft'], connectedRight && styles$v['Backdrop-connectedRight']);
...
var _ref$9 = /*#__PURE__*/React__default.createElement(ScrollLock$1, null);
...
function Backdrop(props) {
  ...
  const className = classNames(styles$x.Backdrop, belowNavigation && styles$x.belowNavigation, transparent && styles$x.transparent);
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, _ref$9, /*#__PURE__*/React__default.createElement("div", {
    className: className,
    onClick: onClick,
...
const Banner = /*#__PURE__*/React.forwardRef(function Banner({
  ...
  const className = classNames(styles$y.Banner, status && styles$y[variationName('status', status)], onDismiss && styles$y.hasDismiss, shouldShowFocus && styles$y.keyFocused, withinContentContainer ? styles$y.withinContentContainer : styles$y.withinPage);
...
var _ref$a = /*#__PURE__*/React__default.createElement(Icon, {
...
function Breadcrumbs({
  ...
  }, _ref$a), /*#__PURE__*/React__default.createElement(VisuallyHidden, null, content));
  const breadcrumbMarkup = 'url' in breadcrumb ? /*#__PURE__*/React__default.createElement(UnstyledLink, {
    key: content,
    url: breadcrumb.url,
    className: styles$z.Breadcrumb,
    onMouseUp: handleMouseUpByBlurring,
...
function Choice({
  ...
  const className = classNames(styles$A.Choice, labelHidden && styles$A.labelHidden, disabled && styles$A.disabled);
...
const Checkbox$1 = /*#__PURE__*/React.forwardRef(function Checkbox({
  ...
  const wrapperClassName = classNames(styles$B.Checkbox, error && styles$B.error);
  const backdropClassName = classNames(styles$B.Backdrop, mouseOver && styles$B.hover);
  ...
  const inputClassName = classNames(styles$B.Input, isIndeterminate && styles$B['Input-indeterminate'], keyFocused && styles$B.keyFocused);
  return (
    /*#__PURE__*/
...
function CheckableButton({
  ...
  const className = plain ? classNames(styles$C.CheckableButton, styles$C['CheckableButton-plain']) : classNames(styles$C.CheckableButton, selectMode && styles$C['CheckableButton-selectMode'], selected && styles$C['CheckableButton-selected'], measuring && styles$C['CheckableButton-measuring']);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className,
    onClick: onToggleAll
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles$C.Checkbox
...
function Indicator({
  ...
  const className = classNames(styles$D.Indicator, pulse && styles$D.pulseIndicator);
  return /*#__PURE__*/React__default.createElement("span", {
    className: className
  });
}
...
function BulkActionButton({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$E.BulkActionButton,
...
const slideClasses = {
  appear: classNames(styles$E.Slide, styles$E['Slide-appear']),
  appearActive: classNames(styles$E.Slide, styles$E['Slide-appearing']),
  enter: classNames(styles$E.Slide, styles$E['Slide-enter']),
  enterActive: classNames(styles$E.Slide, styles$E['Slide-entering']),
  exit: classNames(styles$E.Slide, styles$E['Slide-exit'])
};
...
class BulkActionsInner extends React.PureComponent {
  ...
  render() {
    ...
    const paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? /*#__PURE__*/React__default.createElement("div", {
      className: styles$E.PaginatedSelectAll
    ...
    const smallScreenGroup = smallScreen ? /*#__PURE__*/React__default.createElement(reactTransitionGroup.Transition, {
      ...
      const smallScreenGroupClassName = classNames(styles$E.Group, styles$E['Group-smallScreen'], styles$E[`Group-${status}`]);
      return /*#__PURE__*/React__default.createElement("div", {
        className: smallScreenGroupClassName,
        ref: this.smallScreenGroupNode
      }, /*#__PURE__*/React__default.createElement("div", {
        className: styles$E.ButtonGroupWrapper
        ...
        className: styles$E.CheckableContainer,
    ...
    const largeScreenGroup = smallScreen ? null : /*#__PURE__*/React__default.createElement(reactTransitionGroup.Transition, {
      ...
      const largeScreenGroupClassName = classNames(styles$E.Group, styles$E['Group-largeScreen'], !measuring && styles$E[`Group-${status}`], measuring && styles$E['Group-measuring']);
      return /*#__PURE__*/React__default.createElement("div", {
...
function TextContainer({
  ...
  const className = classNames(styles$F.TextContainer, spacing && styles$F[variationName('spacing', spacing)]);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  }, children);
}
...
function CalloutCard({
  ...
  const imageClassName = classNames(styles$G.Image, onDismiss && styles$G.DismissImage);
  return /*#__PURE__*/React__default.createElement(Card, null, /*#__PURE__*/React__default.createElement("div", {
    ...
    className: styles$G.CalloutCard
  }, /*#__PURE__*/React__default.createElement("div", {
...
function RadioButton({
  ...
  const ariaDescribedBy = describedBy.length ? describedBy.join(' ') : undefined;
  const inputClassName = classNames(styles$I.Input, keyFocused && styles$I.keyFocused);
  const backdropClassName = classNames(styles$I.Backdrop, mouseOver && styles$I.hover);
  return /*#__PURE__*/React__default.createElement(Choice, {
    ...
    className: styles$I.RadioButton
  }, /*#__PURE__*/React__default.createElement("input", {
    id: id,
    name: name,
    value: value,
...
function ChoiceList({
  ...
  const className = classNames(styles$J.ChoiceList, titleHidden && styles$J.titleHidden);
  ...
  const choicesMarkup = choices.map(choice => {
    ...
    const children = renderedChildren ? /*#__PURE__*/React__default.createElement("div", {
      className: styles$J.ChoiceChildren
  ...
  const errorMarkup = error && /*#__PURE__*/React__default.createElement("div", {
    className: styles$J.ChoiceError
  }, /*#__PURE__*/React__default.createElement(InlineError, {
    message: error,
    fieldID: finalName
  }));
...
function Collapsible({
  ...
  const wrapperClassName = classNames(styles$K.Collapsible, isFullyClosed && styles$K.isFullyClosed, expandOnPrint && styles$K.expandOnPrint);
...
class AlphaPicker extends React.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      className: styles$L.AlphaPicker,
      ref: this.setSliderHeight
    }, /*#__PURE__*/React__default.createElement("div", {
      className: styles$L.ColorLayer,
      style: {
        background
      }
...
class ColorPicker extends React.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      className: styles$L.ColorPicker,
      id: id,
      onMouseDown: this.handlePickerDrag
    }, /*#__PURE__*/React__default.createElement("div", {
      ref: this.setColorNode,
      className: styles$L.MainColor
    }, /*#__PURE__*/React__default.createElement("div", {
      className: styles$L.ColorLayer,
      style: {
...
function Cell({
  ...
  const className = classNames(styles$M.Cell, styles$M[`Cell-${variationName('verticalAlign', verticalAlign)}`], firstColumn && styles$M['Cell-firstColumn'], firstColumn && truncate && styles$M['Cell-truncated'], header && styles$M['Cell-header'], total && styles$M['Cell-total'], totalInFooter && styles$M['Cell-total-footer'], numeric && styles$M['Cell-numeric'], sortable && styles$M['Cell-sortable'], sorted && styles$M['Cell-sorted']);
  const headerClassName = classNames(header && styles$M.Heading, header && contentType === 'text' && styles$M['Heading-left']);
  const iconClassName = classNames(sortable && styles$M.Icon);
...
function Navigation({
  ...
  const pipMarkup = columnVisibilityData.map((column, index) => {
    const className = classNames(styles$M.Pip, column.isVisible && styles$M['Pip-visible']);
    return /*#__PURE__*/React__default.createElement("div", {
      className: className,
      key: `pip-${index}`
    });
...
class DataTableInner extends React.PureComponent {
  constructor(...args) {
    ...
    this.defaultRenderRow = (row, index) => {
      const className = classNames(styles$M.TableRow);
      const {
        columnContentTypes,
        truncate = false,
        verticalAlign
  ...
  render() {
    ...
    const className = classNames(styles$M.DataTable, condensed && styles$M.condensed);
    const wrapperClassName = classNames(styles$M.TableWrapper, condensed && styles$M.condensed);
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      className: styles$M.ScrollContainer,
...
const Day = /*#__PURE__*/React.memo(function Day({
  ...
  if (!day) {
    return /*#__PURE__*/React__default.createElement("td", {
      className: styles$N.EmptyDayCell,
  ...
  const dayCellClassName = classNames(styles$N.DayCell, selected && styles$N['DayCell-selected'], (inRange || inHoveringRange) && !disabled && styles$N['DayCell-inRange'], isLastSelectedDay && styles$N['DayCell-lastInRange'], isFirstSelectedDay && styles$N['DayCell-firstInRange'], isHoveringRight && styles$N['DayCell-hoverRight'], rangeIsDifferent && styles$N['DayCell-hasRange']);
  const dayClassName = classNames(styles$N.Day, selected && styles$N['Day-selected'], disabled && styles$N['Day-disabled'], today && styles$N['Day-today'], (inRange || inHoveringRange) && !disabled && styles$N['Day-inRange'], isLastSelectedDay && styles$N['Day-lastInRange'], isFirstSelectedDay && styles$N['Day-firstInRange'], isHoveringRight && styles$N['Day-hoverRight'], rangeIsDifferent && styles$N['Day-hasRange']);
...
const Weekday = /*#__PURE__*/React.memo(function Weekday({
  ...
  const className = classNames(styles$N.Weekday, current && styles$N['Weekday-current']);
...
function Month({
  ...
  const className = classNames(styles$N.Title, current && styles$N['Month-current']);
  ...
  const weeksMarkup = weeks.map((week, index) => /*#__PURE__*/React__default.createElement("tr", {
    className: styles$N.Week,
    key: index
  }, week.map(renderWeek)));
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$N.MonthContainer
  }, /*#__PURE__*/React__default.createElement("table", {
    role: "grid",
    className: styles$N.Month
    ...
    className: styles$N.WeekHeadings
...
function DatePicker({
  ...
  const datePickerClassName = classNames(styles$N.DatePicker);
  return /*#__PURE__*/React__default.createElement("div", {
    id: id,
    ...
    className: styles$N.MonthLayout
...
function DescriptionList({
  ...
  const terms = items.reduce((allTerms, {
    ...
    key: `dt${index}`,
    className: styles$O.Term
  }, term), /*#__PURE__*/React__default.createElement("dd", {
    key: `dd${index}`,
    className: styles$O.Description
  }, description)], []);
  const className = classNames(styles$O.DescriptionList, spacing === 'tight' && styles$O.spacingTight);
...
function DisplayText({
  ...
  const className = classNames(styles$P.DisplayText, size && styles$P[variationName('size', size)]);
  return /*#__PURE__*/React__default.createElement(Element, {
    className: className
  }, children);
}
...
function FileUpload(props) {
  ...
  const buttonStyles = size === 'extraLarge' || size === 'large' ? classNames(styles$Q.Button, size && size !== 'extraLarge' && styles$Q.slim, focused && styles$Q.focused, disabled && styles$Q.disabled) : null;
  const buttonMarkup = (size === 'extraLarge' || size === 'large') && buttonStyles ? /*#__PURE__*/React__default.createElement("div", {
    className: buttonStyles
  }, actionTitle) : null;
  const actionTitleClassName = classNames(styles$Q.ActionTitle, focused && !disabled && styles$Q['ActionTitle-focused'], disabled && styles$Q['ActionTitle-disabled']);
  const actionTitleMarkup = /*#__PURE__*/React__default.createElement("div", {
    className: actionTitleClassName
  }, actionTitle);
  const fileUploadClassName = classNames(styles$Q.FileUpload, measuring && styles$Q.measuring, size === 'small' && styles$Q.FileUploadSmallView);
  let viewMarkup;
...
const DropZone = function DropZone({
  ...
  const classes = classNames(styles$R.DropZone, outline && styles$R.hasOutline, focused && styles$R.focused, (active || dragging) && styles$R.isDragging, disabled && styles$R.isDisabled, (internalError || error) && styles$R.hasError, styles$R[variationName('size', size)], measuring && styles$R.measuring);
  const dragOverlay = (active || dragging) && (!internalError || !error) && overlay && overlayMarkup(polarisIcons.DragDropMajor, 'primary', overlayTextWithDefault);
...
function EmptyState({
  ...
  const withinContentContainer = React.useContext(WithinContentContext);
  const className = classNames(styles$S.EmptyState, fullWidth && styles$S.fullWidth, imageContained && styles$S.imageContained, withinContentContainer ? styles$S.withinContentContainer : styles$S.withinPage);
  ...
  const footerContentMarkup = footerContent ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$S.FooterContent
  ...
  const detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$S.DetailsContainer
  }, /*#__PURE__*/React__default.createElement("div", {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    className: styles$S.Section
  }, detailsMarkup, /*#__PURE__*/React__default.createElement("div", {
    className: styles$S.ImageContainer
  }, imageMarkup)));
}
...
function ExceptionList({
  ...
  const items = itemsList.map((item, index) => {
    ...
    const itemClasses = classNames(styles$U.Item, status && styles$U[variationName('status', status)]);
    const iconMarkup = icon ? /*#__PURE__*/React__default.createElement(Icon, {
      source: icon
    }) : /*#__PURE__*/React__default.createElement("span", {
      className: styles$U.Bullet
    });
    ...
    const descriptionMarkup = description && /*#__PURE__*/React__default.createElement("span", {
      className: styles$U.Description
    }, description);
  ...
  return /*#__PURE__*/React__default.createElement("ul", {
    className: styles$U.ExceptionList
  }, items);
}
...
function Tag({
  ...
  const i18n = useI18n();
  const className = classNames(styles$V.Tag, disabled && styles$V.disabled, onClick && styles$V.clickable, onRemove && styles$V.removable);
...
const BOTTOM_CLASS_NAMES = {
  enter: classNames(styles$W.Bottom, styles$W.enterBottom),
  enterActive: classNames(styles$W.Bottom, styles$W.enterBottomActive),
  exit: classNames(styles$W.Bottom, styles$W.exitBottom),
  exitActive: classNames(styles$W.Bottom, styles$W.exitBottomActive)
};
const RIGHT_CLASS_NAMES = {
  enter: classNames(styles$W.Right, styles$W.enterRight),
  enterActive: classNames(styles$W.Right, styles$W.enterRightActive),
  exit: classNames(styles$W.Right, styles$W.exitRight),
  exitActive: classNames(styles$W.Right, styles$W.exitRightActive)
};
function Sheet({
  children,
  open,
...
function Item$4({
  ...
  const className = classNames(styles$X.Item, focused && styles$X['Item-focused']);
  return /*#__PURE__*/React__default.createElement("div", {
    onBlur: forceFalseFocused,
    onFocus: forceTrueFocused,
    className: className
...
class ConnectedFilterControl extends React.Component {
  ...
  render() {
    ...
    const className = classNames(styles$X.ConnectedFilterControl, rightPopoverableActions && styles$X.right);
    ...
    const RightContainerClassName = classNames(styles$X.RightContainer, !shouldRenderMoreFiltersButton && styles$X.RightContainerWithoutMoreFilters, queryFieldHidden && styles$X.queryFieldHidden);
    ...
    const moreFiltersButtonContainerClassname = classNames(styles$X.MoreFiltersButtonContainer, actionsToRender.length === 0 && styles$X.onlyButtonVisible);
    ...
    const proxyButtonMarkup = rightPopoverableActions ? /*#__PURE__*/React__default.createElement("div", {
      className: styles$X.ProxyButtonContainer,
    ...
    const auxMarkup = auxiliary ? /*#__PURE__*/React__default.createElement("div", {
      className: styles$X.AuxiliaryContainer
    }, auxiliary) : null;
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, proxyButtonMarkup, /*#__PURE__*/React__default.createElement("div", {
      ...
      className: styles$X.CenterContainer
    }, /*#__PURE__*/React__default.createElement(Item$4, null, children)) : null, rightMarkup, rightActionMarkup, /*#__PURE__*/React__default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })), auxMarkup));
  }
...
function TagsWrapper({
  ...
  if (hidden) {
    return /*#__PURE__*/React__default.createElement(VisuallyHidden, null, children);
  }
...
class FiltersInner extends React.Component {
  ...
  render() {
    ...
    const filtersContentMarkup = filters.map((filter, index) => {
      ...
      const className = classNames(styles$Y.FilterTriggerContainer, filterIsOpen && styles$Y.open, index === 0 && styles$Y.first, filters.length !== 1 && index === filters.length - 1 && styles$Y.last);
      ...
      const appliedFilterBadgeMarkup = appliedFilterContent ? /*#__PURE__*/React__default.createElement("div", {
        className: styles$Y.AppliedFilterBadgeContainer
      }, /*#__PURE__*/React__default.createElement(Badge, {
        size: "small",
        status: "new"
      }, appliedFilterContent)) : null;
      const collapsibleID = `${filter.key}Collapsible`;
      const buttonClassName = classNames(styles$Y.FilterTrigger);
      return /*#__PURE__*/React__default.createElement("div", {
        key: filter.key,
        className: className
      }, /*#__PURE__*/React__default.createElement("button", {
        ...
        className: styles$Y.FilterTriggerLabelContainer
      }, /*#__PURE__*/React__default.createElement("h3", {
        className: styles$Y.FilterTriggerTitle
        ...
        className: styles$Y.FilterTriggerIcon
      }, /*#__PURE__*/React__default.createElement(Icon, {
        source: icon,
        color: "base"
        ...
        className: styles$Y.FilterNodeContainer
    ...
    const filtersControlMarkup = /*#__PURE__*/React__default.createElement(ConnectedFilterControl, {
    ...
    }, hideQueryField ? null : /*#__PURE__*/React__default.createElement(TextField, {
      ...
      prefix: /*#__PURE__*/React__default.createElement("span", {
        className: styles$Y.SearchIcon
      }, _ref2$3),
      clearButton: true,
      onClearButtonClick: onQueryClear,
      disabled: disabled
    }));
    const filtersContainerHeaderClassname = classNames(styles$Y.FiltersContainerHeader);
    ...
    const filtersDesktopFooterClassname = classNames(styles$Y.FiltersContainerFooter);
    ...
    const filtersMobileFooterMarkup = /*#__PURE__*/React__default.createElement("div", {
      className: styles$Y.FiltersMobileContainerFooter
    }, this.hasAppliedFilters() ? /*#__PURE__*/React__default.createElement(Button, {
      onClick: onClearAll,
      fullWidth: true
    }, i18n.translate('Polaris.Filters.clearAllFilters')) : /*#__PURE__*/React__default.createElement("div", {
      className: styles$Y.EmptyFooterState
    }, /*#__PURE__*/React__default.createElement(TextStyle, {
      variation: "subdued"
    ...
    const tagsMarkup = !hideTags ? /*#__PURE__*/React__default.createElement(TagsWrapper, {
      hidden: shouldHideTagsContainer
    }, /*#__PURE__*/React__default.createElement("div", {
      className: styles$Y.TagsContainer,
      "aria-live": "polite"
    ...
    const filtersMobileContainerContentClassName = classNames(styles$Y.FiltersMobileContainerContent);
    const filtersDesktopContainerContentClassName = classNames(styles$Y.FiltersDesktopContainerContent);
    const filtersContainerMarkup = isNavigationCollapsed ? /*#__PURE__*/React__default.createElement(Sheet, {
      ...
      className: styles$Y.FiltersContainer
  ...
  generateFilterMarkup(filter) {
    ...
    const clearButtonMarkup = !filter.hideClearButton && /*#__PURE__*/React__default.createElement(Button, {
      plain: true,
...
function FooterHelp({
  ...
  const className = classNames(styles$Z.FooterHelp);
  const iconProps = {
...
function Group({
  ...
  const className = classNames(condensed ? styles$_.condensed : styles$_.grouped);
...
const ToastManager = /*#__PURE__*/React.memo(function ToastManager({
  ...
  return /*#__PURE__*/React__default.createElement(Portal, null, /*#__PURE__*/React__default.createElement(EventListener, {
    ...
    className: styles$10.ToastManager,
    "aria-live": "assertive"
...
const toastClasses = {
  enter: classNames(styles$10.ToastWrapper, styles$10['ToastWrapper-enter']),
  enterDone: classNames(styles$10.ToastWrapper, styles$10['ToastWrapper-enter-done']),
  exit: classNames(styles$10.ToastWrapper, styles$10['ToastWrapper-exit'])
};
...
function Dialog(_ref) {
  ...
  const classes = classNames(styles$12.Modal, large && styles$12.sizeLarge, limitHeight && styles$12.limitHeight);
...
const fadeUpClasses = {
  appear: classNames(styles$12.animateFadeUp, styles$12.entering),
  appearActive: classNames(styles$12.animateFadeUp, styles$12.entered),
  enter: classNames(styles$12.animateFadeUp, styles$12.entering),
  enterActive: classNames(styles$12.animateFadeUp, styles$12.entered),
  exit: classNames(styles$12.animateFadeUp, styles$12.exiting),
  exitActive: classNames(styles$12.animateFadeUp, styles$12.exited)
};
...
function Footer({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$13.Footer
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles$13.FooterContent
  }, /*#__PURE__*/React__default.createElement(Stack, {
    alignment: "center"
  }, /*#__PURE__*/React__default.createElement(Stack.Item, {
    fill: true
...
function CloseButton({
  ...
  return /*#__PURE__*/React__default.createElement("button", {
    onClick: onClick,
    className: styles$14.CloseButton,
...
function Header$1({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: titleHidden || !children ? styles$15.titleHidden : styles$15.Header
  }, /*#__PURE__*/React__default.createElement("div", {
    id: id,
...
function Section$3({
  ...
  const className = classNames(styles$16.Section, flush && styles$16.flush, subdued && styles$16.subdued);
...
const Modal = function Modal({
  ...
  if (open) {
    ...
    dialog = /*#__PURE__*/React__default.createElement(Dialog, {
      ...
      className: styles$17.BodyWrapper
...
function ContextualSaveBar$1({
  ...
  const logoMarkup = alignContentFlush || contextControl ? null : /*#__PURE__*/React__default.createElement("div", {
    className: styles$18.LogoContainer,
    style: {
      width
    }
  }, imageMarkup);
  const contextControlMarkup = contextControl ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$18.ContextControl
  }, contextControl) : null;
  const contentsClassName = classNames(styles$18.Contents, fullWidth && styles$18.fullWidth);
...
function CSSAnimation({
  ...
  const wrapperClassName = classNames(className, styles$19[variationName('start', type)], inProp && styles$19[variationName('end', type)]);
...
class FrameInner extends React.PureComponent {
  ...
  render() {
    ...
    const navClassName = classNames(styles$1a.Navigation, showMobileNavigation && styles$1a['Navigation-visible']);
    ...
    const navigationMarkup = navigation ? /*#__PURE__*/React__default.createElement(TrapFocus, {
    ...
    }, /*#__PURE__*/React__default.createElement("div", Object.assign({}, mobileNavAttributes, {
      ...
      type: "button",
      className: styles$1a.NavigationDismiss,
    ...
    const topBarMarkup = topBar ? /*#__PURE__*/React__default.createElement("div", Object.assign({
      className: styles$1a.TopBar
    }, layer.props, dataPolarisTopBar.props, {
      id: APP_FRAME_TOP_BAR
    }), topBar) : null;
    const globalRibbonMarkup = globalRibbon ? /*#__PURE__*/React__default.createElement("div", {
      className: styles$1a.GlobalRibbonContainer,
      ref: this.setGlobalRibbonContainer
    }, globalRibbon) : null;
    const skipClassName = classNames(styles$1a.Skip, skipFocused && styles$1a.focused);
    ...
    const frameClassName = classNames(styles$1a.Frame, navigation && styles$1a.hasNav, topBar && styles$1a.hasTopBar);
...
const navTransitionClasses = {
  enter: classNames(styles$1a['Navigation-enter']),
  enterActive: classNames(styles$1a['Navigation-enterActive']),
  enterDone: classNames(styles$1a['Navigation-enterActive']),
  exit: classNames(styles$1a['Navigation-exit']),
  exitActive: classNames(styles$1a['Navigation-exitActive'])
};
...
var styles$1b = {
  ...
  "SubTableRow": "Polaris-IndexTable__SubTableRow",
  ...
  "StickyColumnHeaderCheckbox": "Polaris-IndexTable__StickyColumnHeaderCheckbox",
...
const Cell$1 = /*#__PURE__*/React.memo(function Cell({
  children,
  flush
}) {
  const cellClassName = classNames(styles$1b.TableCell, flush && styles$1b['TableCell-flush']);
  return /*#__PURE__*/React__default.createElement("td", {
...
function useIndexSelectionChange() {
  const onSelectionChange = React.useContext(IndexSelectionChangeContext);
...
function useIndexRow() {
  const indexRow = React.useContext(IndexRowContext);
...
const Checkbox$2 = /*#__PURE__*/React.memo(function Checkbox() {
  const i18n = useI18n();
  const {
    resourceName,
    condensed
  ...
  const wrapperClassName = classNames(styles$1c.Wrapper, condensed ? styles$1c.condensed : styles$1c.expanded);
  const Wrapper = condensed ? React.Fragment : CheckboxWrapper;
  return /*#__PURE__*/React__default.createElement(Wrapper, null, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1c.TableCellContentContainer
  }, /*#__PURE__*/React__default.createElement("div", {
    className: wrapperClassName,
    onClick: onInteraction,
    onKeyUp: onInteraction,
    onChange: stopPropagation$1
  }, /*#__PURE__*/React__default.createElement(Checkbox$1, {
    id: itemId,
...
function CheckboxWrapper({
  ...
  const checkboxClassName = classNames(styles$1b.TableCell, styles$1b['TableCell-first']);
  return /*#__PURE__*/React__default.createElement("td", {
...
var _ref$j = /*#__PURE__*/React__default.createElement(Checkbox$2, null);
...
const Row = /*#__PURE__*/React.memo(function Row({
  ...
  const rowClassName = classNames(styles$1b.TableRow, condensed && styles$1b.condensedRow, selected && styles$1b['TableRow-selected'], subdued && styles$1b['TableRow-subdued'], hovered && styles$1b['TableRow-hovered']);
  ...
  return /*#__PURE__*/React__default.createElement(RowContext.Provider, {
    value: contextValue
  }, /*#__PURE__*/React__default.createElement(RowHoveredContext.Provider, {
    value: hovered
  }, /*#__PURE__*/React__default.createElement(RowWrapper, {
    key: id,
...
function ScrollContainer({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$1d.ScrollContainer,
...
function AfterInitialMount({
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, content);
}
...
function IndexProvider({
  ...
  return /*#__PURE__*/React__default.createElement(IndexContext.Provider, {
    value: contextValue
  }, /*#__PURE__*/React__default.createElement(IndexRowContext.Provider, {
    value: rowContextValue
  }, /*#__PURE__*/React__default.createElement(IndexSelectionChangeContext.Provider, {
...
var _ref$k = /*#__PURE__*/React__default.createElement(Spinner, {
  size: "small"
});
...
function IndexTableBase({
  ...
  const onboardingScrollButtons = React.useRef(false);
  ...
  const stickyHeaderCheckboxElement = React.useRef(null);
  ...
  const resizeTableHeadings = React.useMemo(() => debounce(() => {
  ...
  const debounceResizeTableScrollbar = React.useCallback(debounce(resizeTableScrollBar, SCROLL_BAR_DEBOUNCE_PERIOD, {
    trailing: true
  ...
  const stickyColumnHeader = /*#__PURE__*/React__default.createElement("div", {
    className: styles$1b.TableHeading,
    ...
    className: styles$1b.StickyColumnHeaderCheckbox,
    ref: stickyHeaderCheckboxElement
  }, renderCheckboxContent()), /*#__PURE__*/React__default.createElement("div", {
    className: styles$1b['StickyTableHeading-second-scrolling']
  ...
  const loadingTransitionClassNames = {
    enter: styles$1b['LoadingContainer-enter'],
    enterActive: styles$1b['LoadingContainer-enter-active'],
    exit: styles$1b['LoadingContainer-exit'],
    exitActive: styles$1b['LoadingContainer-exit-active']
  };
  const loadingMarkup = /*#__PURE__*/React__default.createElement(reactTransitionGroup.CSSTransition, {
    in: loading,
    ...
    className: styles$1b.LoadingPanel
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1b.LoadingPanelRow
  }, _ref$k, /*#__PURE__*/React__default.createElement("span", {
    className: styles$1b.LoadingPanelText
  }, i18n.translate('Polaris.IndexTable.resourceLoadingAccessibilityLabel', {
    resourceNamePlural: resourceName.plural.toLocaleLowerCase()
  })))));
  const stickyTableClassNames = classNames(styles$1b.StickyTable, condensed && styles$1b['StickyTable-condensed']);
  const shouldShowBulkActions = bulkActionsSelectable && selectedItemsCount || isSmallScreenSelectable;
  const stickyHeaderMarkup = /*#__PURE__*/React__default.createElement("div", {
    className: stickyTableClassNames,
    role: "presentation"
  }, /*#__PURE__*/React__default.createElement(Sticky, {
    boundingElement: stickyWrapper
  }, isSticky => {
    const stickyHeaderClassNames = classNames(styles$1b.StickyTableHeader, isSticky && styles$1b['StickyTableHeader-isSticky']);
    const bulkActionClassNames = classNames(styles$1b.BulkActionsWrapper, condensed && styles$1b['StickyTableHeader-condensed'], isSticky && styles$1b['StickyTableHeader-isSticky']);
    const shouldShowActions = !condensed || selectedItemsCount;
    const promotedActions = shouldShowActions ? promotedBulkActions : [];
    const actions = shouldShowActions ? bulkActions : [];
    const bulkActionsMarkup = shouldShowBulkActions ? /*#__PURE__*/React__default.createElement("div", {
      className: bulkActionClassNames,
      "data-condensed": condensed
    }, loadingMarkup, /*#__PURE__*/React__default.createElement(BulkActions, {
    ...
    const stickyColumnHeaderClassNames = classNames(styles$1b.StickyTableColumnHeader, hasMoreLeftColumns && styles$1b['StickyTableColumnHeader-isScrolling']);
    const headerMarkup = condensed ? /*#__PURE__*/React__default.createElement("div", {
      className: styles$1b.HeaderWrapper
    }, loadingMarkup, sort, /*#__PURE__*/React__default.createElement(Button, {
      icon: polarisIcons.EnableSelectionMinor,
      onClick: toggleIsSmallScreenSelectable
    }, i18n.translate('Polaris.IndexTable.selectButtonText'))) : /*#__PURE__*/React__default.createElement("div", {
      className: stickyHeaderClassNames,
      ref: stickyHeaderWrapperElement
    }, loadingMarkup, /*#__PURE__*/React__default.createElement("div", {
      className: stickyColumnHeaderClassNames
    }, stickyColumnHeader), /*#__PURE__*/React__default.createElement("div", {
      className: styles$1b.StickyTableHeadings,
      ref: stickyHeaderElement
    }, stickyHeadingsMarkup));
    const stickyContent = bulkActionsMarkup ? bulkActionsMarkup : headerMarkup;
    return stickyContent;
  }));
  const scrollBarWrapperClassNames = classNames(styles$1b.ScrollBarContainer, condensed && styles$1b.scrollBarContainerCondensed);
  const scrollBarClassNames = classNames(tableElement.current && tableInitialized && styles$1b.ScrollBarContent);
  const scrollBarMarkup = itemCount > 0 ? /*#__PURE__*/React__default.createElement(AfterInitialMount, null, /*#__PURE__*/React__default.createElement("div", {
    className: scrollBarWrapperClassNames
  }, /*#__PURE__*/React__default.createElement("div", {
    onScroll: handleScrollBarScroll,
    className: styles$1b.ScrollBar,
    ref: scrollBarElement
  }, /*#__PURE__*/React__default.createElement("div", {
    className: scrollBarClassNames
  })))) : null;
  const tableClassNames = classNames(styles$1b.Table, hasMoreLeftColumns && styles$1b['Table-scrolling'], selectMode && styles$1b.disableTextSelection, selectMode && shouldShowBulkActions && styles$1b.selectMode);
  const emptyStateMarkup = emptyState ? emptyState : /*#__PURE__*/React__default.createElement(EmptySearchResult, {
  ...
  const sharedMarkup = /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }), /*#__PURE__*/React__default.createElement(AfterInitialMount, null, stickyHeaderMarkup));
  const bodyMarkup = condensed ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, sharedMarkup, /*#__PURE__*/React__default.createElement("ul", {
    "data-selectmode": Boolean(selectMode || isSmallScreenSelectable),
    className: styles$1b.CondensedList,
    ref: condensedListElement
  }, children)) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null, sharedMarkup, /*#__PURE__*/React__default.createElement(ScrollContainer, {
    ...
    className: styles$1b.HeadingRow
  }, headingsMarkup)), /*#__PURE__*/React__default.createElement("tbody", {
    ref: tableBodyRef
  }, children))));
  const tableContentMarkup = itemCount > 0 ? bodyMarkup : /*#__PURE__*/React__default.createElement("div", {
    className: styles$1b.EmptySearchResultWrapper
  }, emptyStateMarkup);
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1b.IndexTable
  }, !shouldShowBulkActions && !condensed && loadingMarkup, tableContentMarkup), scrollBarMarkup);

  function renderHeading(heading, index) {
    const isSecond = index === 0;
    const headingContentClassName = classNames(styles$1b.TableHeading, isSecond && styles$1b['TableHeading-second']);
    ...
    const headingContent = /*#__PURE__*/React__default.createElement("th", {
    ...
    const checkboxClassName = classNames(styles$1b.TableHeading, index === 0 && styles$1b['TableHeading-first']);
    const checkboxContent = /*#__PURE__*/React__default.createElement("th", {
      className: checkboxClassName,
      key: `${heading}-${index}`,
      "data-index-table-heading": true
  ...
  function renderCheckboxContent() {
    return /*#__PURE__*/React__default.createElement("div", {
      className: styles$1b.ColumnHeaderCheckboxWrapper
    }, /*#__PURE__*/React__default.createElement(Checkbox$1, {
  ...
  function renderHeadingContent(heading) {
    ...
    if (heading.new) {
      headingContent = /*#__PURE__*/React__default.createElement(Stack, {
        wrap: false,
        alignment: "center"
      }, /*#__PURE__*/React__default.createElement("span", null, heading.title), /*#__PURE__*/React__default.createElement(Badge, {
        status: "new"
      }, i18n.translate('Polaris.IndexTable.onboardingBadgeText')));
    } else if (heading.hidden) {
      headingContent = /*#__PURE__*/React__default.createElement(VisuallyHidden, null, heading.title);
    } else {
  ...
  function renderStickyHeading(heading, index) {
    ...
    const stickyHeadingClassName = classNames(styles$1b.TableHeading, index === 0 && styles$1b['StickyTableHeading-second']);
    return /*#__PURE__*/React__default.createElement("div", {
  ...
  function getPaginatedSelectAllAction() {
    ...
    const actionText = selectedItemsCount === SELECT_ALL_ITEMS$1 ? i18n.translate('Polaris.IndexTable.undo') : i18n.translate('Polaris.IndexTable.selectAllItems', {
      itemsLength: itemCount,
      resourceNamePlural: resourceName.plural.toLocaleLowerCase()
    });
    return {
...
function IndexTable(_ref2) {
  ...
  }, /*#__PURE__*/React__default.createElement(IndexTableBase, indexTableBaseProps, children));
}
...
function KeyboardKey({
  ...
  return /*#__PURE__*/React__default.createElement("kbd", {
    className: styles$1e.KeyboardKey
  }, key);
}
...
function AnnotatedSection(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$1f.AnnotatedSection
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1f.AnnotationWrapper
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1f.Annotation
    ...
    className: styles$1f.AnnotationDescription
  }, descriptionMarkup))), /*#__PURE__*/React__default.createElement("div", {
    className: styles$1f.AnnotationContent
  }, children)));
}
...
function Section$4({
  ...
  const className = classNames(styles$1f.Section, secondary && styles$1f['Section-secondary'], fullWidth && styles$1f['Section-fullWidth'], oneHalf && styles$1f['Section-oneHalf'], oneThird && styles$1f['Section-oneThird']);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  }, children);
}
...
function Link({
  ...
  if (external && typeof children === 'string') {
    ...
    childrenMarkup = /*#__PURE__*/React__default.createElement(React__default.Fragment, null, children, /*#__PURE__*/React__default.createElement("span", {
      className: styles$1g.IconLockup
    }, /*#__PURE__*/React__default.createElement("span", {
      className: styles$1g.IconLayout
    }, /*#__PURE__*/React__default.createElement(Icon, {
  ...
  return /*#__PURE__*/React__default.createElement(BannerContext.Consumer, null, BannerContext => {
    ...
    const className = classNames(styles$1g.Link, shouldBeMonochrome && styles$1g.monochrome, removeUnderline && styles$1g.removeUnderline);
...
const List = function List({
  ...
  const className = classNames(styles$1h.List, type && styles$1h[variationName('type', type)]);
...
function MediaCard({
  ...
  const primaryActionMarkup = primaryAction ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1i.PrimaryAction
  }, buttonFrom(primaryAction)) : null;
  const secondaryActionMarkup = secondaryAction ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1i.SecondaryAction
  }, buttonFrom(secondaryAction, {
    plain: true
  })) : null;
  const actionClassName = classNames(styles$1i.ActionContainer, portrait && styles$1i.portrait);
  ...
  const mediaCardClassName = classNames(styles$1i.MediaCard, portrait && styles$1i.portrait);
  const mediaContainerClassName = classNames(styles$1i.MediaContainer, portrait && styles$1i.portrait, size === 'small' && styles$1i.sizeSmall);
  const infoContainerClassName = classNames(styles$1i.InfoContainer, portrait && styles$1i.portrait, size === 'small' && styles$1i.sizeSmall);
  return /*#__PURE__*/React__default.createElement(Card, null, /*#__PURE__*/React__default.createElement("div", {
    ...
    className: styles$1i.Description
...
var _ref$l = /*#__PURE__*/React__default.createElement(Indicator, {
  pulse: true
});
...
function Item$7({
  ...
  if (url == null) {
    const _className = classNames(styles$1j.Item, disabled && styles$1j['Item-disabled'], keyFocused && styles$1j.keyFocused);

    return /*#__PURE__*/React__default.createElement("li", {
      className: styles$1j.ListItem
    }, /*#__PURE__*/React__default.createElement("button", {
      type: "button",
  ...
  const secondaryActionMarkup = secondaryAction && /*#__PURE__*/React__default.createElement(UnstyledLink, {
    ...
    className: styles$1j.SecondaryAction,
    tabIndex: tabIndex,
    "aria-disabled": disabled,
  ...
  const itemClassName = classNames(styles$1j.Item, disabled && styles$1j['Item-disabled'], selected && subNavigationItems.length === 0 && styles$1j['Item-selected'], showExpanded && styles$1j.subNavigationActive, keyFocused && styles$1j.keyFocused);
  ...
  if (subNavigationItems.length > 0) {
    ...
    const SecondaryNavigationClassName = classNames(styles$1j.SecondaryNavigation, showExpanded && styles$1j.isExpanded, !icon && styles$1j['SecondaryNavigation-noIcon']);
  ...
  const className = classNames(styles$1j.ListItem, secondaryAction && styles$1j['ListItem-hasAction']);
  return /*#__PURE__*/React__default.createElement("li", {
    className: className
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1j.ItemWrapper
  }, /*#__PURE__*/React__default.createElement(UnstyledLink, Object.assign({
    url: url,
...
function Section$5({
  ...
  const className = classNames(styles$1j.Section, separator && styles$1j['Section-withSeparator'], fill && styles$1j['Section-fill']);
  const actionMarkup = action && /*#__PURE__*/React__default.createElement("button", {
    type: "button",
    className: styles$1j.Action,
  ...
  const sectionHeadingMarkup = title && /*#__PURE__*/React__default.createElement("li", {
    className: styles$1j.SectionHeading
  }, /*#__PURE__*/React__default.createElement("span", {
    className: styles$1j.Text
  }, title), actionMarkup);
  ...
  const toggleClassName = classNames(styles$1j.Item, styles$1j.RollupToggle);
  ...
  const activeItemsMarkup = rollup && additionalItems.length > 0 && /*#__PURE__*/React__default.createElement("li", {
    className: styles$1j.RollupSection
...
const Navigation$1 = function Navigation({
  ...
  const logoMarkup = logo ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1j.LogoContainer
  ...
  return /*#__PURE__*/React__default.createElement(NavigationContext.Provider, {
    ...
    className: styles$1j.PrimaryNavigation
  }, children))));
};
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? /*#__PURE__*/React__default.createElement(PositionedOverlay, {
    active: active,
    activator: activator,
    preferredPosition: preferredPosition,
  ...
  function renderTooltip(overlayDetails) {
    ...
    const containerClassName = classNames(styles$1k.TooltipOverlay, measuring && styles$1k.measuring, positioning === 'above' && styles$1k.positionedAbove);
    const contentStyles = measuring ? undefined : {
...
function Pagination({
  ...
  const prev = /*#__PURE__*/React__default.createElement(Button, {
    outline: true,
    icon: polarisIcons.ChevronLeftMinor,
  ...
  const next = /*#__PURE__*/React__default.createElement(Button, {
    outline: true,
    icon: polarisIcons.ChevronRightMinor,
  ...
  return /*#__PURE__*/React__default.createElement("nav", {
    "aria-label": navLabel,
    ref: node
  }, previousButtonEvents, nextButtonEvents, /*#__PURE__*/React__default.createElement(ButtonGroup, {
    segmented: !label
...
function Title({
  ...
  const pageTitleClassName = thumbnail ? styles$1l.hasThumbnail : undefined;
  return /*#__PURE__*/React__default.createElement("div", {
    className: pageTitleClassName
  }, thumbnailMarkup, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1l.TitleAndSubtitleWrapper
...
function Header$2({
  ...
  const breadcrumbMarkup = breadcrumbs.length > 0 ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1m.BreadcrumbWrapper
  ...
  const paginationMarkup = pagination && !isNavigationCollapsed ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1m.PaginationWrapper
  }, /*#__PURE__*/React__default.createElement(Pagination, pagination)) : null;
  const additionalNavigationMarkup = additionalNavigation ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1m.AdditionalNavigationWrapper
  ...
  const navigationMarkup = breadcrumbMarkup || paginationMarkup || additionalNavigationMarkup ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1m.Navigation
  ...
  const pageTitleMarkup = /*#__PURE__*/React__default.createElement("div", {
    className: styles$1m.TitleWrapper
  ...
  const actionMenuMarkup = secondaryActions.length > 0 || hasGroupsWithActions(actionGroups) ? /*#__PURE__*/React__default.createElement(ActionMenu, {
    actions: secondaryActions,
    groups: actionGroups,
    rollup: isNavigationCollapsed
  }) : null;
  const additionalMetadataMarkup = additionalMetadata ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1m.AdditionalMetaData
  }, /*#__PURE__*/React__default.createElement(TextStyle, {
    variation: "subdued"
  }, additionalMetadata)) : null;
  const headerClassNames = classNames(styles$1m.Header, isSingleRow && styles$1m.isSingleRow, titleHidden && styles$1m.titleHidden, navigationMarkup && styles$1m.hasNavigation, actionMenuMarkup && styles$1m.hasActionMenu, isNavigationCollapsed && styles$1m.mobileView, !breadcrumbs.length && styles$1m.noBreadcrumbs, title && title.length < LONG_TITLE && styles$1m.mediumTitle, title && title.length > LONG_TITLE && styles$1m.longTitle);
  const {
    slot1,
    slot2,
    slot3,
...
function PrimaryActionMarkup({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$1m.PrimaryActionWrapper
  }, content);
}
...
function Page(_ref) {
  ...
  const className = classNames(styles$1n.Page, fullWidth && styles$1n.fullWidth, narrowWidth && styles$1n.narrowWidth);
...
function PageActions({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$1o.PageActions
  }, /*#__PURE__*/React__default.createElement(Stack, {
...
function PolarisTestProvider({
  ...
  const processedThemeConfig = _objectSpread2(_objectSpread2({}, theme), {}, {
    colorScheme: 'light'
  });
...
function ProgressBar({
  ...
  const i18n = useI18n();
  const className = classNames(styles$1p.ProgressBar, size && styles$1p[variationName('size', size)]);
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    className: styles$1p.Progress,
    value: parsedProgress,
    max: "100"
  }), /*#__PURE__*/React__default.createElement("div", {
    className: styles$1p.Indicator,
    style: {
...
class DualThumb extends React.Component {
  ...
  render() {
    ...
    const ariaDescribedBy = describedBy.length ? describedBy.join(' ') : undefined;
    const trackWrapperClassName = classNames(styles$1q.TrackWrapper, error && styles$1q.error, disabled && styles$1q.disabled);
    const thumbLowerClassName = classNames(styles$1q.Thumbs, styles$1q.ThumbLower, disabled && styles$1q.disabled);
    const thumbUpperClassName = classNames(styles$1q.Thumbs, styles$1q.ThumbUpper, disabled && styles$1q.disabled);
    ...
    const outputLowerClassName = classNames(styles$1q.Output, styles$1q.OutputLower);
    ...
    const outputUpperClassName = classNames(styles$1q.Output, styles$1q.OutputUpper);
    ...
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Labelled, {
      ...
      className: styles$1q.Track,
      style: cssVars,
      ref: this.track
    }), /*#__PURE__*/React__default.createElement("div", {
      className: styles$1q['Track--dashed']
    }), /*#__PURE__*/React__default.createElement("div", {
      id: idLower,
      ...
      ref: this.thumbLower
    }), outputMarkupLower, /*#__PURE__*/React__default.createElement("div", {
      id: idUpper,
...
function SingleThumb(props) {
  ...
  const outputMarkup = !disabled && output && /*#__PURE__*/React__default.createElement("output", {
    htmlFor: id,
    className: styles$1r.Output
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1r.OutputBubble
  }, /*#__PURE__*/React__default.createElement("span", {
    className: styles$1r.OutputText
  }, clampedValue)));
  const prefixMarkup = prefix && /*#__PURE__*/React__default.createElement("div", {
  ...
  const className = classNames(styles$1r.SingleThumb, error && styles$1r.error, disabled && styles$1r.disabled);
  return /*#__PURE__*/React__default.createElement(Labelled, {
    id: id,
    label: label,
    error: error,
    ...
    className: styles$1r.InputWrapper
  }, /*#__PURE__*/React__default.createElement("input", {
    type: "range",
  ...
  render() {
    ...
    if (media || selectable) {
      ownedMarkup = /*#__PURE__*/React__default.createElement("div", {
        className: classNames(styles$1s.Owned, !mediaMarkup && styles$1s.OwnedNoMedia)
      }, handleMarkup, mediaMarkup);
    }

    const className = classNames(styles$1s.ResourceItem, focused && styles$1s.focused, selectable && styles$1s.selectable, selected && styles$1s.selected, selectMode && styles$1s.selectMode, persistActions && styles$1s.persistActions, focusedInner && styles$1s.focusedInner);
    const listItemClassName = classNames(styles$1s.ListItem, focused && !focusedInner && styles$1s.focused);
    ...
    const containerClassName = classNames(styles$1s.Container, verticalAlignment && styles$1s[variationName('alignment', verticalAlignment)]);
    ...
    return /*#__PURE__*/React__default.createElement("li", {
      ...
      className: styles$1s.ItemWrapper
    }, /*#__PURE__*/React__default.createElement("div", {
      ref: this.setNode,
      className: className,
      onClick: this.handleClick,
...
function Select({
  ...
  const className = classNames(styles$1t.Select, error && styles$1t.error, disabled && styles$1t.disabled);
  ...
  const inlineLabelMarkup = labelInline && /*#__PURE__*/React__default.createElement("span", {
    className: styles$1t.InlineLabel
  }, label);
  ...
  const contentMarkup = /*#__PURE__*/React__default.createElement("div", {
    ...
    className: styles$1t.SelectedOption
...
const DateSelector = /*#__PURE__*/React.memo(function DateSelector({
  ...
  const datePredicateMarkup = showDatePredicate && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1v.DateTextField
    ...
    className: styles$1v.DatePicker
...
function FilterControl({
  ...
  const appliedFiltersMarkup = appliedFilters.map(appliedFilter => {
    ...
    return /*#__PURE__*/React__default.createElement("li", {
      className: styles$1w.AppliedFilter,
      key: filterId
  ...
  const appliedFiltersWrapper = appliedFilters.length > 0 ? /*#__PURE__*/React__default.createElement("ul", {
    className: styles$1w.AppliedFilters
...
const ResourceList = function ResourceList({
  ...
  const [smallScreen, setSmallScreen] = React.useState(isSmallScreen$1());
  ...
  const handleResize = debounce(() => {
    const newSmallScreen = isSmallScreen$1();
  ...
  React.useEffect(() => {
    ...
    if ((!selectedItems || selectedItems.length === 0) && !isSmallScreen$1()) {
      setSelectMode(false);
    }
  ...
  const handleSelectionChange = (selected, id, sortOrder, shiftKey) => {
    ...
    if (newlySelectedItems.length === 0 && !isSmallScreen$1()) {
      handleSelectMode(false);
  ...
  const loadingOverlay = loading ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("li", {
  ...
  const className = classNames(styles$1u.ItemWrapper, loading && styles$1u['ItemWrapper-isLoading']);
  const loadingWithoutItemsMarkup = loading && !itemsExist ? /*#__PURE__*/React__default.createElement("div", {
    className: className,
    tabIndex: -1
  }, loadingOverlay) : null;
  const resourceListClassName = classNames(styles$1u.ResourceList, loading && styles$1u.disabledPointerEvents, selectMode && styles$1u.disableTextSelection);
...
function SkeletonBodyText({
  ...
  for (let i = 0; i < lines; i++) {
    bodyTextLines.push( /*#__PURE__*/React__default.createElement("div", {
      className: styles$1x.SkeletonBodyText,
      key: i
    }));
  }

  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$1x.SkeletonBodyTextContainer
  }, bodyTextLines);
}
...
function SkeletonDisplayText({
  ...
  const className = classNames(styles$1y.DisplayText, size && styles$1y[variationName('size', size)]);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  });
}
...
var _ref$q = /*#__PURE__*/React__default.createElement(SkeletonDisplayText, {
  size: "large"
});
...
function SkeletonPage({
  ...
  const i18n = useI18n();
  const className = classNames(styles$1z.Page, fullWidth && styles$1z.fullWidth, narrowWidth && styles$1z.narrowWidth);
  const titleContent = title ? /*#__PURE__*/React__default.createElement("h1", {
    className: styles$1z.Title
  }, title) : /*#__PURE__*/React__default.createElement("div", {
    className: styles$1z.SkeletonTitle
  });
  const titleMarkup = /*#__PURE__*/React__default.createElement("div", {
    className: styles$1z.TitleWrapper
  }, titleContent);
  const primaryActionMarkup = primaryAction ? /*#__PURE__*/React__default.createElement("div", {
...
function SkeletonThumbnail({
  ...
  const className = classNames(styles$1A.SkeletonThumbnail, size && styles$1A[variationName('size', size)]);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  });
}
...
class Item$8 extends React.PureComponent {
  ...
  render() {
    ...
    const classname = classNames(styles$1B.Item);
    const sharedProps = {
      id,
...
function Panel({
  ...
  const className = classNames(styles$1B.Panel, hidden && styles$1B['Panel-hidden']);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className,
    id: id,
    role: "tabpanel",
...
function Tab({
  ...
  const className = classNames(styles$1B.Tab, selected && styles$1B['Tab-selected']);
  let tabIndex;
  ...
  const tabContainerClassNames = classNames(styles$1B.TabContainer, selected && styles$1B.Underline);
...
const TabMeasurer = /*#__PURE__*/React.memo(function TabMeasurer({
  ...
  const classname = classNames(styles$1B.Tabs, styles$1B.TabMeasurer);
  return /*#__PURE__*/React__default.createElement("div", {
    className: classname,
    ref: containerNode
  }, /*#__PURE__*/React__default.createElement(EventListener, {
...
class TabsInner extends React.PureComponent {
  constructor(...args) {
    ...
    this.handleFocus = event => {
      ...
      if (target.classList.contains(styles$1B.Tab) || target.classList.contains(styles$1B.Item)) {
        let tabToFocus = -1;
      ...
      if (target.classList.contains(styles$1B.DisclosureActivator)) {
        return;
      ...
      if (relatedTarget instanceof HTMLElement && !relatedTarget.classList.contains(styles$1B.Tab) && !relatedTarget.classList.contains(styles$1B.Item) && !relatedTarget.classList.contains(styles$1B.DisclosureActivator)) {
        this.setState({
          tabToFocus: selected
        });
      }
    ...
    this.handleBlur = event => {
      ...
      if (target instanceof HTMLElement && !target.classList.contains(styles$1B.Tab) && !target.classList.contains(styles$1B.Item)) {
        this.setState({
          tabToFocus: -1
        });
      }
  ...
  render() {
    ...
    const classname = classNames(styles$1B.Tabs, fitted && styles$1B.fitted, disclosureActivatorVisible && styles$1B.fillSpace);
    const disclosureTabClassName = classNames(styles$1B.DisclosureTab, disclosureActivatorVisible && styles$1B['DisclosureTab-visible']);
    const disclosureButtonClassName = classNames(styles$1B.DisclosureActivator, hasCustomDisclosure && styles$1B.Tab);
    const disclosureButtonContentWrapperClassName = classNames(styles$1B.Title, hasCustomDisclosure && styles$1B.titleWithIcon);
    const disclosureButtonContent = hasCustomDisclosure ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, disclosureText, _ref$r) : _ref2$7;
    ...
    const activator = disclosureText ? /*#__PURE__*/React__default.createElement("div", {
      className: styles$1B.TabContainer
    }, disclosureButton) : disclosureButton;
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("div", {
      className: styles$1B.Wrapper
...
function Thumbnail({
  ...
  const className = classNames(styles$1C.Thumbnail, size && styles$1C[variationName('size', size)]);
...
var _ref$s = /*#__PURE__*/React__default.createElement(ScrollLock$1, null);
...
function SearchDismissOverlay({
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, visible ? _ref$s : null, /*#__PURE__*/React__default.createElement("div", {
    ref: node,
    className: classNames(styles$1D.SearchDismissOverlay, visible && styles$1D.visible),
...
function Search({
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, overlayMarkup, /*#__PURE__*/React__default.createElement("div", {
    className: classNames(styles$1E.Search, visible && styles$1E.visible)
  }, /*#__PURE__*/React__default.createElement(ThemeProvider, {
    theme: {
      colorScheme: 'dark'
    }
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1E.SearchContent
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1E.Results
  }, children)))));
}
...
function SearchField({
  ...
  const className = classNames(styles$1F.SearchField, (focused || active || forceActive) && styles$1F.focused);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className,
    onFocus: handleFocus,
    onBlur: handleBlur
    ...
    className: classNames(styles$1F.Backdrop, showFocusBorder && styles$1F.BackdropShowFocusBorder)
  }));
}
...
function MessageIndicator({
  ...
  const indicatorMarkup = active && /*#__PURE__*/React__default.createElement("div", {
    className: styles$1G.MessageIndicator
  });
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$1G.MessageIndicatorWrapper
...
function Menu(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Popover, {
    activator: /*#__PURE__*/React__default.createElement("div", {
      className: styles$1I.ActivatorWrapper
    }, /*#__PURE__*/React__default.createElement("button", {
      type: "button",
      className: styles$1I.Activator,
      onClick: onOpen,
      "aria-label": accessibilityLabel
    }, activatorContent)),
    active: open,
...
function UserMenu({
  ...
  const activatorContentMarkup = /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(MessageIndicator, {
    ...
    className: styles$1J.Details
  }, /*#__PURE__*/React__default.createElement("p", {
    className: styles$1J.Name
  }, name), /*#__PURE__*/React__default.createElement("p", {
    className: styles$1J.Detail
  }, detail)));
...
var _ref$u = /*#__PURE__*/React__default.createElement(Icon, {
...
const TopBar = function TopBar({
  ...
  const iconClassName = classNames(styles$1K.NavigationIcon, focused && styles$1K.focused);
  ...
  if (contextControl) {
    ...
    const className = classNames(styles$1K.LogoContainer, showNavigationToggle || searchField ? styles$1K.LogoDisplayControl : styles$1K.LogoDisplayContainer);
    contextMarkup = /*#__PURE__*/React__default.createElement("div", {
      className: className
    }, /*#__PURE__*/React__default.createElement(UnstyledLink, {
      url: logo.url || '',
      className: styles$1K.LogoLink,
      style: {
        width
      }
    }, /*#__PURE__*/React__default.createElement(Image, {
...
function VideoThumbnail({
  ...
  const timeStampMarkup = videoLength ? /*#__PURE__*/React__default.createElement("p", {
    className: classNames(styles$1L.Timestamp, showVideoProgress && styles$1L.withProgress)
  ...
  if (showVideoProgress) {
    ...
    progressMarkup = /*#__PURE__*/React__default.createElement("div", {
      ...
      className: styles$1L.ProgressBar,
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$1L.Thumbnail,
    style: {
      backgroundImage: `url(${thumbnailUrl})`
    }
  }, /*#__PURE__*/React__default.createElement("button", {
    type: "button",
    className: styles$1L.PlayButton,
...
(function (SelectionType) {
  ...
  SelectionType["Multi"] = "multi";
  SelectionType["Single"] = "single";
})(SelectionType$1 || (SelectionType$1 = {}));
...
function useIndexResourceState(resources, {
  ...
  const handleSelectionChange = React.useCallback((selectionType, isSelecting, selection) => {
    if (selectionType === SelectionType$1.All) {
